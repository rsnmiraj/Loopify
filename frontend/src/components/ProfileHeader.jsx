...
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
	const { chatHide, setChatHide, user, setUser } = useContext(ChatContext)
	...
	return (
		<div className='bg-white shadow rounded-lg mb-6 overflow-hidden'>
			...
			<div
				...
				style={{
					backgroundImage: `url('${editedData.bannerImg || userData.bannerImg || "/banner.jpg"}')`,
				}}
			>
				{isEditing && (
				...
				<div className='text-center mb-4'>
					{isEditing ? (
						<input
							...
							className='text-2xl font-bold mb-2 text-center w-full border border-gray-300 p-2 rounded'
						/>
					) : (
					...
					{isEditing ? (
						<input
							...
							className='text-gray-600 text-center w-full border border-gray-300 p-2 rounded'
						/>
					) : (
					...
					<div className='flex justify-center items-center mt-2'>
						...
						{isEditing ? (
							<input
								...
								className='text-gray-600 text-center border border-gray-300 p-2 rounded'
							/>
						) : (
				...
				{isOwnProfile ? (
					isEditing ? (
						...
						<button
							...
							className='w-full bg-fuchsia-500  text-white py-2 px-4 rounded-full hover:bg-primary-dark transition duration-300'
						>
							Edit Profile
						</button>
					)
